			...
			<div class="left" >
				...
				<div class="right1">
					...
					<div class="afterlogin">
						<p style="text-align: center; color: #2d3436;font-size: 20px;font-family: 'Mansalva', cursive;">Xin chào Admin:<br>  [<?php echo $_SESSION['HoTenND'] ?>]</p>
						<form method="post">
				...
				<div class="right1" style="margin-top: 30px; height: auto"> <!-- danh sách phụ kiện-->
					...
					<div class="right0" style="">
						<i class="fas fa-khachhang-cog"></i>
						<p style="">Tùy chọn</p>
					</div>	
	...
	<div class="footer" style="clear: both">
				<div class="footer1">
					...
					<div class="rightfooter">
						...
						<p>Địa chỉ: Hưng Thạnh - Cần Thơ</p>
						<p>Điện thoại: 0355671551 - 0767281097</p>
						<p>Email: duyb1605326@student.ctu.edu.vn</p>
					</div>
				</div>	
				<div class="bothfooter">
					&copy;Copyright - Nguyễn Khánh Duy - B1605326
				</div>
			</div> 
		</div>	
</body>
